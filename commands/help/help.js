...
module.exports = {
  ...
  run: async (client, message, args) => {
   ...
   let helpEmbed = new MessageEmbed()
      .setTitle("**Here are __Exper Bot__ commands**")
      ...
      .addField('Important Links ','**[Invite Me](https://discord.com/api/oauth2/authorize?client_id=976097733381349386&permissions=8&scope=bot)** **• [Support](https://discord.gg/kB7ecN53u5)**  | **[Website](https://saturnbot.npgop.repl.co/)**')
